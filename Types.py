...
DEFAULT_DNABERT6_OUTPUT_SIZE:               int         = 768
DEFAULT_DNABERT6_WINDOW_SIZE:               int         = 400
DEFAULT_DNABERT6_LEARNING_RATE:             float       = 2e-5
DEFAULT_DNABERT6_EPOCHS:                    int         = 10
...
DEFAULT_SMORFCNN_MULTI_KERNEL_LIST:          list        = [3,5,7,11]
DEFAULT_SMORFCNN_MULTI_GAP_KERNEL_LIST:      list        = [3,5,7,11]
DEFAULT_SMORFCNN_MULTI_S_KERNEL_K_LIST:      list        = [3,5,7,11]
DEFAULT_SMORFCNN_MULTI_GAP_KERNEL_GAP_LIST:  list        = [1,2,3]
DEFAULT_SMORFCNN_MULTI_S_KERNEL_S_LIST:      list        = [2,3]
DEFAULT_SMORFCNN_OUTPUT_CHANNELS_KERNEL:     int         = 128
DEFAULT_SMORFCNN_OUTPUT_CHANNELS_G_KERNEL:   int         = 128
DEFAULT_SMORFCNN_OUTPUT_CHANNELS_S_KERNEL:   int         = 128
DEFAULT_SMORFCNN_MKC_REDUCTION_SIZE:         int         = 128
DEFAULT_SMORFCNN_MGKC_REDUCTION_SIZE:        int         = 128
DEFAULT_SMORFCNN_MSKC_REDUCTION_SIZE:        int         = 128
DEFAULT_SMORFCNN_DNABERT_REDUCTION_SIZE:     int         = 128
DEFAULT_SMORFCNN_SCALAR_INCREASE_SIZE:       int         = 128
DEFAULT_SMORFCNN_CLASSES:                    int         = 1
DEFAULT_SMORFCNN_CLASSIFIER_L1_OUTPUT:       int         = 256
DEFAULT_SMORFCNN_CLASSIFIER_L2_OUTPUT:       int         = 64
DEFAULT_SMORFCNN_CLASSIFIER_DROPOUT:         float       = 0.5
DEFAULT_SMORFCNN_LEARNING_RATE:              float       = 2e-5
...
DEFAULT_SMORFCNN_TRAIN_BATCH_SIZE:           int         = 32
DEFAULT_SMORFCNN_VALIDATION_BATCH_SIZE:      int         = 32
DEFAULT_SMORFCNN_TEST_BATCH_SIZE:            int         = 32
